...
window.onload = function(){
  var elements = document.getElementsByClassName("site-title")
      ...
      <?php
        ...
        <div id="social_icons">
            ...
            <?php if ( of_get_option('twitter', true) != "") { ?>
			 <a href="http://twitter.com/<?php echo of_get_option('twitter', true); ?>" title="Twitter" ><img src="<?php echo get_stylesheet_directory_uri()."/images/twitter.png"; ?>"></a>
             <?php } ?>
             <?php if ( of_get_option('google', true) != "") { ?>
			 <a href="<?php echo of_get_option('google', true); ?>" title="Google Plus" ><img src="<?php echo get_stylesheet_directory_uri()."/images/google.png"; ?>"></a>
             <?php } ?>
             <?php if ( of_get_option('pinterest', true) != "") { ?>
			 <a href="<?php echo of_get_option('pinterest', true); ?>" title="Pinterest" ><img src="<?php echo get_stylesheet_directory_uri()."/images/pinterest.png"; ?>"></a>
             <?php } ?>
             <?php if ( of_get_option('linkedin', true) != "") { ?>
			 <a href="<?php echo of_get_option('linkedin', true); ?>" title="Linked In" ><img src="<?php echo get_stylesheet_directory_uri()."/images/linkedin.png"; ?>"></a>
             <?php } ?>
             <?php if ( of_get_option('instagram', true) != "") { ?>
			 <a href="<?php echo of_get_option('instagram', true); ?>" title="Instagram" ><img src="<?php echo get_stylesheet_directory_uri()."/images/instagram.png"; ?>"></a>
             <?php } ?>
             <?php if ( of_get_option('youtube', true) != "") { ?>
			 <a href="<?php echo of_get_option('youtube', true); ?>" title="Youtube" ><img src="<?php echo get_stylesheet_directory_uri()."/images/youtube.png"; ?>"></a>
             <?php } ?>
    	...
    	<?php
		  		...
		  		for ($i=1;$i<6;$i++) {
					if ( of_get_option('slide'.$i, true) != "" ) {
						echo "<li><a href='".of_get_option('slideurl'.$i, true)."'><img src='".of_get_option('slide'.$i, true)."' title='".of_get_option('slidetitle'.$i, true)."'></a></li>";    
						$slider_flag = true;
					}
				}
           ?>
